...
#define GLTHREAD_TO_TYPE(fn_name, type_name, field_name)                        \
    static inline type_name * fn_name(glthread_t *glthreadptr){                   \
        return (type_name *)((char *)(glthreadptr) - (char *)&(((type_name *)0)->field_name)); \
    }
